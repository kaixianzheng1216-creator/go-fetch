...
import (
	...
	ua "github.com/kaixianzheng1216-creator/go-fetch/internal/useragent"
)
...
func BuildEventInput(request *http.Request, payload model.CollectPayload, now time.Time) model.EventInput {
