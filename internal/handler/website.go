...
func NewWebsite(websites service.Website, currentUser func(context.Context) domain.User, websiteLookupError func(error) error) WebsiteHandler {
	return WebsiteHandler{websites: websites, currentUser: currentUser, websiteLookupError: websiteLookupError}
}

type websiteRequest struct {
	Body requestdto.WebsiteRequest
}
...
func (handler WebsiteHandler) ListWebsites(ctx context.Context, _ *requestdto.Empty) (*responsedto.WebsiteListOutput, error) {
	websites, err := handler.websites.List(ctx, handler.currentUser(ctx).ID)
	if err != nil {
		return nil, huma.Error500InternalServerError("加载站点列表失败")
	}

	return responsedto.NewWebsiteListOutput(responsedto.ToWebsites(websites)), nil
}

func (handler WebsiteHandler) CreateWebsite(ctx context.Context, input *websiteRequest) (*responsedto.WebsiteOutput, error) {
	...
	return responsedto.NewWebsiteOutput(responsedto.ToWebsite(website)), nil
}

func (handler WebsiteHandler) GetWebsite(ctx context.Context, input *websiteIDRequest) (*responsedto.WebsiteOutput, error) {
...
func (handler WebsiteHandler) UpdateWebsite(ctx context.Context, input *updateWebsiteRequest) (*responsedto.WebsiteOutput, error) {
...
func (handler WebsiteHandler) DeleteWebsite(ctx context.Context, input *websiteIDRequest) (*responsedto.OKOutput, error) {
